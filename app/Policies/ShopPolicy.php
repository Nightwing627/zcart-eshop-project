...
class ShopPolicy
{
    ...
    {
        return (new Authorize($user, 'view_shop'))->check();
    }
    ...
    {
        return (new Authorize($user, 'view_shop', $shop))->check();
    }
    ...
    {
        return (new Authorize($user, 'add_shop'))->check();
    }
    ...
    {
        return (new Authorize($user, 'edit_shop', $shop))->check();
    }
    ...
    {
        return (new Authorize($user, 'delete_shop', $shop))->check();
    }
}
