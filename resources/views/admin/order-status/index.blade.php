		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\OrderStatus::class)
					<a href="javascript:void(0)" data-link="{{ route('admin.utility.orderStatus.create') }}" class="ajax-modal-btn btn btn-new btn-flat">{{ trans('app.add_status') }}</a>
				@endcan
			</div>
		</div> <!-- /.box-header -->
		<div class="box-body">
				...
				<tbody>
					...
					<tr>
						...
						<td class="row-options">
							@can('update', $status)
								<a href="javascript:void(0)" data-link="{{ route('admin.utility.orderStatus.edit', $status->id) }}"  class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.edit') }}" class="fa fa-edit"></i></a>&nbsp;
							@endcan
