<div class="form-group">
  ...
  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.payment_status_name') }}"></i>
...
<div class="form-group">
  ...
  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.payment_status_color') }}"></i>
...
<div class="form-group">
  ...
  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.payment_status_send_email') }}"></i>
...
<div id="option_email_template"  class="form-group
  ...
  <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.payment_status_email_template') }}"></i>
