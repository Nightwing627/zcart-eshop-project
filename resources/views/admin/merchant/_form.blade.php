...
<div class="form-group">
  ...
  @if(isset($merchant) && File::exists(image_path('merchants') . $merchant->id . '_150x150.png'))
  <label>

    <img src="{{ get_image_src($merchant->id, 'users', '150x150') }}" width="80px" alt="{{ trans('app.avatar') }}">
