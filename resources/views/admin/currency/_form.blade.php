...
<div class="row">
  <div class="col-sm-6 nopadding-right">
    <div class="form-group">
      ...
      <div class="help-block with-errors"><small>https://en.wikipedia.org/wiki/ISO_4217</small></div>
    </div>
  </div>
  ...
  <div class="col-md-6 nopadding-right">
    <div class="form-group">
      <div class="input-group">
        ...
        {!! Form::checkbox('symbol_first', null, 1, ['id' => 'symbol_first', 'class' => 'icheckbox_line']) !!}
