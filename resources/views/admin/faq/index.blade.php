						    ...
						    @foreach($topics as $topic )
						        <tr>
									...
									<td class="row-options text-muted small">
										@can('create', App\Faq::class)
											<a href="{{ route('admin.utility.faqTopic.edit', $topic->id) }}"  class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.edit') }}" class="fa fa-edit"></i></a>&nbsp;
			        ...
			        <tbody>
				        @foreach($faqs as $faq )
					        <tr>
					          <td width="60%">
									@can('update', $faq)
					                    <a href="{{ route('admin.utility.faq.edit', $faq->id) }}"  class="ajax-modal-btn"><strong>{!! $faq->question !!}</strong></a>
									@else
					          ...
					          <td class="row-options text-muted small">
								@can('update', $faq)
				                    <a href="{{ route('admin.utility.faq.edit', $faq->id) }}"  class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.edit') }}" class="fa fa-edit"></i></a>&nbsp;
								@endcan
								@can('delete', $faq)
