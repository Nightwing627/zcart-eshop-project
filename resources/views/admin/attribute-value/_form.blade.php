...
<div id="color-option" class="
	...
	<div class="form-group">
	  <label for="exampleInputFile"> {{ trans('app.form.pattern') }}</label>
 	  @if(isset($attributeValue) && File::exists(image_path('patterns') . $attributeValue->id . '_150x150.png'))
	  <label>
		<img src="{{ get_image_src($attributeValue->id, 'patterns', '150x150') }}" width="80px" alt="{{ trans('app.image') }}">
