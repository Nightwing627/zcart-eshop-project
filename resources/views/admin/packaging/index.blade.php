...
@section('buttons')
	<a href="{{ route('admin.shipping.packaging.create') }}" data-target="myDynamicModal" data-toggle="modal" class="btn btn-new btn-flat">{{ trans('app.add_packaging') }}</a>
@endsection
				...
				<tbody>
					...
					<tr>
						...
						<td class="row-options">
							<a href="{{ route('admin.shipping.packaging.edit', $packaging->id) }}" data-target="myDynamicModal" data-toggle="modal"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.edit') }}" class="fa fa-edit"></i></a>&nbsp;
