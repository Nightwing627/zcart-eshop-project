...
@section('content')
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">{{ trans('app.countries') }}</h3>
			...
			<table class="table table-hover table-2nd-no-sort">
				<thead>
					<tr>
						...
						<th>{{ trans('app.capital') }}</th>
						<th>{{ trans('app.number_of_states') }}</th>
				...
				<tbody id="massSelectArea">
					...
					<tr>
						...
						<td class="row-options">
							@can('update', $country)
								<a href="{{ route('admin.setting.country.states', $country->id) }}"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.states') }}" class="fa fa-expand"></i></a>&nbsp;
							@endcan
