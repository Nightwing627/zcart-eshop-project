...
<div class="form-group">
  ...
  @if(isset($warehouse) && File::exists(image_path('warehouses') . $warehouse->id . '_150x150.png'))
  <label>
    <img src="{{ get_image_src($warehouse->id, 'warehouses', '150x150') }}" width="80px" alt="{{ trans('app.image') }}">
