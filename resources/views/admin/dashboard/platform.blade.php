        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-image">
              <img class="img-circle" src="http://placehold.it/128" alt="Avatar">
            </div>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget widget-user-2">
            <div class="widget-user-header bg-yellow">
              <div class="widget-user-image">
                <img class="img-circle" src="http://placehold.it/128" alt="Logo">
              </div>
              <!-- /.widget-user-image -->
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                <li><a href="#">Last 30 days sale <span class="pull-right">$5000</span></a></li>
                <li><a href="#">Total sale <span class="pull-right">$15000</span></a></li>
              </ul>
            </div>
          </div>
          <!-- /.widget-user -->
