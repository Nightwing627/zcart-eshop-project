	    ...
	    <div class="box-header with-border">
	      ...
	      <div class="box-tools pull-right">
			@can('create', App\Slider::class)
				<a href="{{ route('admin.appearance.slider.create') }}" class="ajax-modal-btn btn btn-new btn-flat">{{ trans('app.add_slider') }}</a>
			@endcan
	      </div>
	    </div> <!-- /.box-header -->
	    <div class="box-body">
				        ...
				        <tr>
					        ...
					        <td>
				          	...
				          	<td class="row-options text-muted small">
								@can('update', $slider)
				                    <a href="{{ route('admin.appearance.slider.edit', $slider->id) }}"  class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.edit') }}" class="fa fa-edit"></i></a>&nbsp;
								@endcan
								@can('delete', $slider)
