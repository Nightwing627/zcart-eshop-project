...
<div class="form-group">
  ...
  @if(isset($supplier) && File::exists(image_path('suppliers') . $supplier->id . '_150x150.png'))
  <label>
    <img src="{{ get_image_src($supplier->id, 'suppliers', '150x150') }}" width="80px" alt="{{ trans('app.image') }}">
