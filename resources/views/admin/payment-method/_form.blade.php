...
<div class="form-group">
	...
	@if(isset($payment_method) && File::exists(image_path('payment-methods') . $payment_method->id . '_150x150.png'))
	<label>
		<img src="{{ get_image_src($payment_method->id, 'payment-methods', '150x150') }}" width="80px" alt="{{ trans('app.image') }}">
