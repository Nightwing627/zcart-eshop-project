        ...
        <div class="modal-body" style="padding: 0px;">
			...
			<div class="card hovercard">
			    <div class="card-background">
					...
					<img src="{{ get_image_src($user->id, 'users', '150x150') }}" class="card-bkimg img-circle" alt="{{ trans('app.avatar') }}">

			    </div>
			    <div class="useravatar">

					<img src="{{ get_image_src($user->id, 'users', '150x150') }}" class="img-circle" alt="{{ trans('app.avatar') }}">
				...
				<div class="tab-content">
				    ...
				    <div class="tab-pane" id="tab_3">
	            		...
	            		@if(config('system_settings.address_geocode'))
					        <div class="row">
			                    <iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.it/maps?q={{ urlencode($user->primaryAddress->toString()) }}&output=embed"></iframe>
					        </div>
