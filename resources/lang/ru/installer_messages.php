...
return array (
  ...
  array (
    ...
    'required' => 'Необходимо установить все требования к серверу, чтобы продолжить',
  ),
  'permissions' => 
  array (
    ...
    'required' => 'Установите разрешения, необходимые для продолжения. Прочитайте документ. для помощи.',
  ),
  'environment' => 
  array (
    'menu' => 
    ...
    array (
      ...
      array (
        ...
        'app_log_level_label_emergency' => 'скорая медицинская помощь',
        'app_url_label' => 'URL приложения',
        'app_url_placeholder' => 'URL приложения',
        'db_connection_failed' => 'Не удалось подключиться к базе данных. Проверьте настройки.',
        ...
        array (
          ...
          'broadcasting_title' => 'Вещание, кеширование, сеанс и очередь',
    ...
    'classic' => 
    array (
      'backup' => 'Чтобы избежать беспорядка, пожалуйста, скопируйте и сохраните конфигурации по умолчанию в другом месте, прежде чем вносить какие-либо изменения.',
  ...
  'install' => 'устанавливать',
  'verified' => 'Лицензия была успешно подтверждена.',
  ...
  array (
    ...
    'migration' => 'Вывод на консоль миграции и семян:',
  ...
  array (
    ...
    array (
      'title' => 'обзор',
      'message' => 'Существует 1 обновление. | Есть :number обновления.',
