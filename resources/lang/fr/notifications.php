...
return array (
  ...
  array (
    ...
    'button_text' => 'Visiter votre profil',
  ),
  'invoice_created' => 
  array (
  ...
  array (
    'subject' => '[ID de commande: :order_id] Le différend a été soumis avec succès',
    'greeting' => 'Bonjour :customer',
  ...
  array (
    'subject' => '[Order ID: :order_id] Nouvelle réponse pour un litige en appel!',
    'greeting' => 'Bonjour!',
  ...
  array (
    ...
    'greeting' => 'Bonjour!',
    'message' => 'Un ou plusieurs de vos objets d\'inventaire deviennent faibles. Il est temps d’ajouter plus d’inventaire pour que l’article reste en ligne sur le marché.',
    'button_text' => 'Mise à jour de l\'inventaire',
  ),
  ...
  array (
    ...
    'message' => ':message',
    'button_text' => 'Voir le message sur le site',
  ),
  'message_replied' => 
  array (
  ...
  array (
    ...
    'button_text' => 'Remplir la commande',
  ),
  'order_updated' => 
  array (
    'subject' => '[ID de commande: :order] le statut de votre commande a été mis à jour!',
    'greeting' => 'Bonjour :customer',
    'message' => 'Ceci est une notification pour vous informer que votre commande [Order ID :order] a été mise à jour. Veuillez voir ci-dessous pour les détails de la commande. Vous pouvez également vérifier vos commandes à partir de votre tableau de bord.',
    'button_text' => 'Visitez la boutique',
  ),
  'order_fulfilled' => 
  array (
  ...
  array (
    ...
    'greeting' => 'Bonjour :user',
    'message' => 'Ceci est une notification pour vous informer que le ticket [ID du ticket: :ticket_id] :subject vient de vous être envoyé. Examinez et répondez au ticket dès que possible.',
    'button_text' => 'Répondre au billet',
  ),
  'ticket_replied' => 
  array (
